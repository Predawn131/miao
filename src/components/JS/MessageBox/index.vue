...
<style lang="scss" scoped>
    .messageBox{width: 200px;height: 140px;border: 1px #ccc solid;border-radius: 4px;background: white;box-shadow: 3px 3px 3px 3px #ccc;position: absolute;left: 50%;top: 50%;margin: -70px 0 0 -100px;}
    ...
    .messageBox > div div{ flex:1; text-align: center; line-height: 40px; border-right:1px #ccc solid;}
